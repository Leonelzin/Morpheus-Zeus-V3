...
Resource            web/system/settings_pom.resource
...
*** Test Cases ***
Validate system (settings webpage) factory default settings
    [Documentation]
    ...    Validate that system factory default settings match project
    ...    requirements.
